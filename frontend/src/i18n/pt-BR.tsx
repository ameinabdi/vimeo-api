const ptBR = {
  ...
  entities: {
    lessons: {
        ...
        label: 'Lessons',
        menu: 'Lessons',
        exporterFileName: 'Lessons_exportados',
        list: {
          menu: 'Lessons',
          title: 'Lessons',
        },
        create: {
          success: 'Lessons salvo com sucesso',
        },
        update: {
          success: 'Lessons salvo com sucesso',
        },
        destroy: {
          success: 'Lessons deletado com sucesso',
        },
        destroyAll: {
          success: 'Lessons(s) deletado com sucesso',
        },
        edit: {
          title: 'Editar Lessons',
        },
        fields: {
          id: 'Id',
          'name': 'Name',
          'embed': 'Embed',
          'chapterIdRange': 'ChapterId',
          'chapterId': 'ChapterId',
          'subjectIdRange': 'SubjectId',
          'subjectId': 'SubjectId',
          'classIdRange': 'ClassId',
          'classId': 'ClassId',
          'levelIdRange': 'LevelId',
          'levelId': 'LevelId',
          'realeaseDateRange': 'RealeaseDate',
        ...
        view: {
          title: 'Visualizar Lessons',
        },
        importer: {
          title: 'Importar Lessons',
          fileName: 'lessons_template_importacao',
          hint:
