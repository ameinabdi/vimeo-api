const es = {
  ...
  entities: {
    lessons: {
        ...
        label: 'Lessons',
        menu: 'Lessons',
        exporterFileName: 'exportacion_lessons',
        list: {
          menu: 'Lessons',
          title: 'Lessons',
        },
        create: {
          success: 'Lessons guardado con éxito',
        },
        update: {
          success: 'Lessons guardado con éxito',
        },
        destroy: {
          success: 'Lessons eliminado con éxito',
        },
        destroyAll: {
          success: 'Lessons(s) eliminado con éxito',
        },
        edit: {
        ...
        importer: {
          ...
          fileName: 'lessons_import_template',
          hint:
